...
public class BasicTests
{
    ...
    public async void ReadWriteTest()
    {
        using (var embedded = new Server())
        {
            ...
            await collection.InsertOneAsync(
                new TestClass() { Id = 12345, TestValue = "Hello world." }
            );
    ...
    public async void DualServerReadWriteTest()
    {
        ...
        using (var embedded2 = new Server())
        {
            ...
            await collection2.InsertOneAsync(
                new TestClass() { Id = 12345, TestValue = "Hello world." }
            );
